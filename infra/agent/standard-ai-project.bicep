// Creates an Azure AI Foundry project (Microsoft.CognitiveServices/accounts/projects)
// as a child of an existing AI Services (Foundry) account.
...
// Used for storage naming conventions / fine-grained role assignments.
...
// Built by convention until a first-class property is exposed.
